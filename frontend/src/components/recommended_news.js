...
function RecommendedNews() {
    return (
        <div className='p-4'>
            ...
            </div><div className='flex w-100 justify-between border-2 border-black rounded-lg h-8 pt-0 pb-1 px-4 mb-2'>
                <div className="flex">
                    <p className='mr-2'>Jan 1 | 12:00</p>
                    <p>TSLA : Happy New Year</p>
                </div>
                <div className="flex">
                    <FontAwesomeIcon className="mt-1 text-green-500" icon={faArrowUp} />
                    <p className='ml-3'>0.251</p>
                </div>
            </div>
            <div className='flex w-100 justify-between border-2 border-black rounded-lg h-8 pt-0 pb-1 px-4 mb-2'>
